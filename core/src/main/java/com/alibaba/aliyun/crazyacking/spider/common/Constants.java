...
public class Constants {
    ...
    public static final String SYSTEM_BUSY = "busy";
    public static final String SYSTEM_EMPTY = "empty";
    public static final String OK = "ok";
    public static final String FORBIDDEN_PAGE_TITILE = "<title>????</title>";
    public static final String REPOST_BASE_STR = "http://weibo.cn/repost/";
    public static final String COMMENT_BASE_STR = "http://weibo.cn/comment/";
